...
export const Home = () => {
  return <>
    ...
    <div className="features bg-black dark:bg-gray-700 py-20 flex justify-center">
      <div className="container w-full max-w-7xl mx-auto flex items-center gap-16">
        <div className="item flex flex-col gap-4 flex-2">
          <h1 className="text-4xl font-semibold text-white">Access freelancers on the go</h1>
          <div className="flex items-center gap-2">
            <p className="text-lg text-white">The best for every budget</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <p className="text-lg text-white"><i className='bx bx-check'></i>Quality work done quickly</p>
          </div>
          <p className="text-base mb-4 text-white">
